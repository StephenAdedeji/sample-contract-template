...
# Accord Protocol Template: firsttemplate
...
```
cicero parse --template ./firsttemplate/ --dsl ./firsttemplate/sample.txt
...
```
cicero execute --template ./firsttemplate/ --dsl ./firsttemplate/sample.txt --data ./firsttemplate/data.json 
```
