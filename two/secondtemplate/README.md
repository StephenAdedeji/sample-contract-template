...
# Accord Protocol Template: secondtemplate
...
```
cicero parse --template ./secondtemplate/ --dsl ./secondtemplate/sample.txt
...
```
cicero execute --template ./secondtemplate/ --dsl ./secondtemplate/sample.txt --data ./secondtemplate/data.json 
```
